...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		posY: rangeInput.offset().top + rangeInput.outerHeight() - 275, // y position
		appendTo: 'body',
		onClose: function(){},
		onOpen: function(){},
		onChange: function(){},
		datepickerOptions: {direction: 'up'} //object containing native UI datepicker API options
	}, settings);
	...
	rp.wrap('<div class="ui-daterangepickercontain"></div>').parent().position(jQuery.extend(options.position, {of: rangeInput}));

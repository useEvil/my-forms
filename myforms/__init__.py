...
def main(global_config, **settings):
    ...
    config.add_route('view', '/view/{id}', view='myforms.views.view', view_renderer='templates/view.pt')
    config.add_route('edit', '/edit/{id}', view='myforms.views.edit', view_renderer='templates/edit.pt')
